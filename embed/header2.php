...
<body>
  ...
  */
  ...
  $query_user_details = "SELECT username, email,password,country FROM `tbl_ai_farm` WHERE username = '".$_SESSION['username']."'";
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 align-self-center">
            <h1 class="display-4 mb-3"><?php echo ucfirst($_SESSION["username"]); ?>'s space</h1>
            <p class="lead mb-4" align="justify"><small>Welcome to ainitro <?php echo ucfirst($return_assoc_array["username"]);?> this is your dashboard and you are expected to take full control of it by initiating a Ai management scheme,Your email address is <?php echo ucfirst($return_assoc_array["email"]);?> and we really love citizens of <?php echo ucfirst($return_assoc_array["country"]);?> so you're definitely welcomed!</small></p>
          </div><!-- /.col-md-6 -->
